                    ...
                    <div className="row s_product_inner justify-content-between">
                        ...
                        <div className="col-lg-5 col-xl-4">
                            <div className="s_product_text">
                                    ...
                                    <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                        ...
                                        <li>
                                            <div className="flex items-center">
                                                ...
                                                <Link to={'/boutique/categorie/reseau'} className="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Réseau</Link>
                                            </div>
                                        </li>
                                        <li aria-current="page">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">{network.title}</span>
                                            </div>
                                        </li>
                                    </ol>
                                </nav>
                                ...
                                <p>{network.features[0]}</p>
                                <p>{network.features[1]}</p>
                                <p>{network.features[2]}</p>
